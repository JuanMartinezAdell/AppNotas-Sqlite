...
class NotasDatabaseHelper (context: Context) : SQLiteOpenHelper (
    ...
    companion object {
        ...
        private const val COLUMN_TITTLE ="titulo"
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val createTableQuery =
            "CREATE TABLE $TABLE_NAME ($COLUMN_ID INTEGER PRIMARY KEY, $COLUMN_TITTLE TEXT, $COLUMN_DESCRIPTION TEXT)"
    ...
    fun getAllNotas() : List<Nota>{
        ...
        while (cursor.moveToNext()){
            ...
            val titulo = cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_TITTLE))
